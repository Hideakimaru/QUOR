	...
	return (
		<>
			...
			>
				...
				<br />
				<p>
					These terms and conditions applies to the MyWatchList app (hereby
					referred to as &quot;Application&quot;) for mobile devices that was
					created by Yehor Marchenko (hereby referred to as &quot;Service
				...
				<br />
				<p>These terms and conditions are effective as of 2024-06-16</p>
				<br />
				...
				<div className='pt-10 flex flex-row justify-center items-center gap-5'>
					<Link
						className='flex flex-row w-40 items-center justify-center py-4 px-2 bg-custom-green rounded-md font-roboto font-bold text-white bg-opacity-50 hover:bg-opacity-100'
						to='/'
					>
						Yes, I&apos;m Agree
					</Link>
