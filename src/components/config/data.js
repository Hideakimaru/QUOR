export const initialData = [
	...
	},
	{
		id: 1,
		title: "Kingdom",
		titleImage: "https://i.imgur.com/uVDRRhN.png",
		contentYear: "2019",
		episodesCount: "6 / 6",
		ratingNumber: "8.3",
		contentGenre: "Action, Drama, Horror",
		contentType: "Series",
		contentDescription:
	...
	},
	{
		...
		contentDescription:
			...
			"  from Helen to help him cope with his grief. John and Daisy connect and spend" +
			"  time driving around in John's vintage 1969 Ford Mustang Mach 1. While at a gas" +
			"  station, John encounters Iosef Tarasov, the son of Russian crime lord Viggo" +
			"  Tarasov, who offers to buy his car. John refuses to sell, which angers Iosef." +
			"  That night, Iosef and his henchmen break into John's house to steal his car," +
			"  beating John unconscious and killing Daisy. Iosef takes the Mustang to" +
			"  Aurelio's chop shop to have the VIN changed. Recognizing the car and learning" +
			"  Iosef stole it from John, Aurelio berates the Russian, punches him, and throws" +
			"  him out of the shop. John visits Aurelio, who tells him that Iosef is Viggo's" +
			"  son. Viggo contacts Aurelio to find out why he struck Iosef; Aurelio tells him" +
			"  what happened. Viggo understands Aurelio's reaction and beats Iosef for his" +
			"  stupidity, telling him about John Wick's history as a notorious assassin known" +
			'  as "Baba Yaga " or "The Boogeyman." When John asked Viggo\'s permission to' +
			'  retire and marry Helen, Viggo assigned him an "impossible task" to complete to' +
			"  leave the assassin's life. John succeeded; his actions laid the foundations" +
			"  for the Tarasov syndicate. Viggo contacts John and tries to convince him to" +
			"  spare Iosef . John silently refuses. To save Iosef, Viggo dispatches a" +
			"  twelve-man team to kill John at his house. John takes out all of the assassins" +
			"  and then calls in a service to professionally clean the scene. Viggo places a" +
			"  $2 million bounty on John's head, and even goes as far as personally offering" +
			"  the contract to John's mentor, Marcus. Marcus warily accepts. John recovers" +
			"  the tools of his trade from under the concrete floor in his home and heads to" +
			"  the Continental Hotel, which caters to the criminal underworld and forbids any" +
			'  "business" from being conducted on the premises. In response, Viggo doubles' +
			"  the bounty for anyone willing to break the Continental's rules and kill John" +
			"  in the hotel. Winston Scott, the owner of the Continental, informs John that" +
			"  Viggo has Iosef sequestered at the Red Circle nightclub, protected by his men." +
			"  John assaults the Red Circle to get to Iosef, and almost kills him but is" +
			"  stopped by Viggo's main henchman Kirill. Returning to the Continental, John" +
			"  uses their services to tend to his wounds. A fellow assassin, Ms. Perkins" +
			"  attempts to claim the bounty on him by sneaking into his room and trying to" +
			"  kill him. John is alerted to the plan by Marcus, allowing John to incapacitate" +
			"  Perkins. John gets the location of Viggo's front organization from Perkins," +
			"  then leaves her unconscious in the care of Harry, another assassin at the" +
			"  Continental, to await judgment for breaking the hotel's rules. Perkins works" +
			"  her way out of her handcuffs, kills Harry and escapes. John heads to a church" +
			"  in Little Russia used by Viggo as a front and destroys Viggo's cache of money" +
			"  and blackmail material. Viggo and his men arrive, allowing John to ambush" +
			"  them. However, Viggo's men overpower John and capture him. As Viggo taunts" +
			"  John for believing that he could leave his criminal past behind, John is" +
			"  rescued by Marcus' intervention. Freeing himself, John kills Kirill and forces" +
			"  Viggo to reveal Iosef's location. John also forces Viggo to pull the $2" +
			"  million contract. John then goes to the safe house and kills Iosef and his" +
			"  bodyguards. Ms. Perkins informs Viggo that John and Marcus have been in" +
			"  contact. Viggo visits Marcus in his home and tortures him for information" +
			"  before executing him. Viggo contacts John to tell him about Marcus' death and" +
			"  plans to have Perkins ambush him. However, Winston calls Perkins into a" +
			"  meeting at the Bethesda Terrace in Central Park where she is executed for" +
			"  breaking the rules of the Continental when she killed Harry. Winston informs" +
			"  John that Viggo intends to escape by helicopter, allowing John to reach him in" +
			"  time. John kills Viggo's henchmen, then engages in a brutal fight with Viggo." +
			"  John eventually kills Viggo after allowing himself to be stabbed to get close" +
			"  enough to finish him. John stops at an animal clinic on the waterfront to" +
			"  treat his wound and frees a pit bull puppy scheduled to be euthanized. John" +
			"  and the dog walk along the same boardwalk where John had his last date with" +
			"  Helen."
	},
	{
		id: 4,
		...
		episodesCount: "1 / 1",
		ratingNumber: "8.4",
		contentGenre: "Animation, Drama, Fantasy",
		contentType: "Anime",
		contentDescription:
	...
	},
	{
		...
		contentDescription:
			...
			"" +
			"Kagaya forecasts Muzan's intentions and enacts a strict training regimen to prepare the Corps for the coming battle. Tamayo develops a serum with the obtained blood samples to cure Nezuko, who is kept in isolation as she recovers. Muzan appears and Kagaya triggers a suicide attack to stagger him. The Hashira ambush Muzan but he traps them all within the Infinity Castle, an endless labyrinth housing Akaza, Upper Two Doma, Upper One Kokushibo, and the newly-ascended members Kaigaku and Nakime: Zenitsu's former partner and Muzan's personal assistant respectively. As Zenitsu kills Kaigaku, Tamayo injects Muzan with a poison she and Shinobu have made to weaken his abilities. When Akaza remembers his human life, he betrays Muzan and commits suicide, while Shinobu sacrifices herself to poison Doma, allowing her protégé Kanao Tsuyuri and Inosuke to kill him. After a harrowing battle, Kokushibo kills both Muichiro and Genya before being killed as well. Muzan kills Tamayo, and later Nakime when she is hypnotized by Yushiro to use her powers against him, but he is forced above ground by the Corps." +
			"" +
	...
	},
	{
		...
		episodesCount: "8 / 8",
		ratingNumber: "8",
		contentGenre: "Action, Adventure, Drama",
		contentType: "Series",
		contentDescription:
